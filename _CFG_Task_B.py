...
folder = "/Users/macbookpro/UCL - MSc Integrated Machine Learning Systems/Y1/Applied Machine Learning I/Final Assignment/AMLS_20-21_SN17024244/Datasets/cartoon_set/"
test_folder = "/Users/macbookpro/UCL - MSc Integrated Machine Learning Systems/Y1/Applied Machine Learning I/Final Assignment/AMLS_20-21_SN17024244/Datasets/cartoon_set_test/"
...
def move_images_fromfolder(folder, destination, extension):
    ...
    for f in files:
        if os.path.splitext(f)[1] in (extension) and int(os.path.splitext(f)[0]) >= 10000:
